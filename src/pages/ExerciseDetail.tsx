    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="clients" className="space-y-4">
          ...
          ) : stats?.clientPerformances.length === 0 ? (
              ...
              <CardContent>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {stats?.clientPerformances.map((client, idx) => (
                        <tr
                          key={client.clientId}
                        ...
                        >
                          ...
                          <td className="py-3 px-2 text-right">
                            {client.maxWeight ? `${client.maxWeight} kg` : '-'}
                          </td>
                          ...
                          <td className="py-3 px-2 text-right text-muted-foreground text-xs">
                            {format(new Date(client.lastUsed), 'd.M.yyyy', { locale: cs })}
                          </td>
                        </tr>
                      ))}
                    </tbody>

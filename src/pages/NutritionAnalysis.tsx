...
export default function NutritionAnalysis() {
  ...
  // Analysis insights (mock for now - could be AI-powered in future)
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Vizuální přehled a interpretace stravovacích dat
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            {insights.patterns.length === 0 ? (
              <p className="text-sm text-muted-foreground">Zatím nedostatek dat pro analýzu</p>
            ) : (
        ...
        <Card>
          ...
          <CardContent>
            {insights.issues.length === 0 ? (
              <p className="text-sm text-muted-foreground">Žádné problémy nenalezeny</p>
            ) : (
              <ul className="space-y-2">
        ...
        <Card>
          ...
          <CardContent>
            {insights.recommendations.length === 0 ? (
              <p className="text-sm text-muted-foreground">Vše vypadá dobře</p>
            ) : (
              <ul className="space-y-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Poměr typů záznamů napříč všemi kampaněmi
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Klienti s nejvíce záznamy ve stravovacích kampaních
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Průměr záznamů/kampaň</p>

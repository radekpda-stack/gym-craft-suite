...
import { Plus, Pencil, Trash2, Package, AlertTriangle, Lock } from 'lucide-react';
...
export function ProductsManagement() {
  ...
  const startEdit = (product: Product) => {
    const canManage = !!user?.id && product.user_id === user.id;
    if (!canManage) return;
                ...
                <>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Switch
                      ...
                      onCheckedChange={() => canManage && handleToggleActive(product)}
                      disabled={!canManage}
                    />
                    <Button
                      variant="ghost"
                      ...
                      disabled={!canManage}
                      title={!canManage ? 'Tuto položku nemůžete upravit' : undefined}
                    >
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button
                          ...
                          disabled={!canManage || deleteProduct.isPending}
                          title={!canManage ? 'Tuto položku nemůžete smazat' : undefined}
                        >

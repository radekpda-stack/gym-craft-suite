...
export function ClientSummaryStrip({
  ...
  return (
     <div className="flex overflow-x-auto snap-x snap-mandatory gap-3 -mx-1 px-1 pb-1 scrollbar-hide sm:grid sm:grid-cols-2 sm:overflow-visible sm:mx-0 sm:px-0 sm:pb-0">

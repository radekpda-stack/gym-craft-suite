...
import { Clock, RefreshCw, Loader2, User, ChevronDown } from 'lucide-react';
...
export function RecentSales({ onRepeatSale, className, defaultCollapsed = false }: RecentSalesProps) {

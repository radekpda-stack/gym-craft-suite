...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    name: 'Nordic Ice',
    nameCs: 'Nordic Ice',
    description: 'Fresh professional with blue accents',
    descriptionCs: 'Svěží profesionální s modrými akcenty',
    preview: {
      primary: '#2B7FE0',
      background: '#F8FAFC',
      card: '#FFFFFF',
  ...
  },
  {
    ...
    name: 'Warm Sand',
    nameCs: 'Warm Sand',
    description: 'Warm elegant with coral accents',
    descriptionCs: 'Teplý elegantní s korálovými akcenty',
    preview: {
      primary: '#E85A38',
      background: '#FAF6F2',
      card: '#FFFFFF',
